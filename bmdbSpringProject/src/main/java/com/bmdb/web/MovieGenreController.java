...
//		return u;
	...
	// get MovieGenre by Genre
	@GetMapping("/getByGenre")
	public @ResponseBody JsonResponse getMovieGenreByGenre(@RequestBody MovieGenre MovieGenre) { // returns the
																									// MovieGenre
		return JsonResponse.getInstance(movieGenreRepository.findByGenre(MovieGenre.getGenre()));
	}
}
